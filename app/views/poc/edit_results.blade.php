...
<div class="panel panel-primary">
	...
	<div class="panel-body">
		...
		@endif
		{{ Form::open(array('url' => 'poc/update_results/'.$patient->id, 'id' => 'form-create-edit_results', 'autocomplete' => 'off')) }}
		...
		<div class="form-group actions-row" style="text-align:right;">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					...
					{{ Form::text('test_date', $result->test_date, array('class' => 'form-control standard-datepicker standard-datepicker-nofuture col-sm-4', 'placeholder' => 'YYYY-MM-DD')) }}
				</div>
