...
<div class="panel-body row">
	...
	<div class="btn-group container col-xs-3">
		<a class="link-tip" href="{{ URL::route('sampletracker.index')}}" data-toggle="tooltip" data-placement="bottom" title="Click to access other resources e.g Sample Tracking, links to Viral load and EID Dashboard, CPHL websites">
			<div class="panel panel-default">
