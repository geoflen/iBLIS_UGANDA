...
<div class="panel-body row">
	...
	<div class="btn-group container col-xs-3">
		<a class="link-tip" href="{{URL::route('poc.pochome')}}" data-toggle="tooltip" data-placement="bottom" title="Click to access other resources e.g links to Viral load and EID Dashboard, CPHL websites">
			<div class="panel panel-default">
			<span class="ion-icon ion-ios-folder"></span> <br><span class="nav_title">POC / EID & TB-Genexpert</span>
			</div>
		</a>
	</div>
</div>
