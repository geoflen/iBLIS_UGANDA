					...
					<div class="form-group">
						<div class="panel-body">
							...
							<div class="form-group">
								...
								{{ Form::select('district_id', array(null => '')+$district,'', array('class' => 'form-control', 'id' => 'district_id')) }}
								<br>

								{{ Form::label('region', 'Region:', array('class' => 'col-sm-2')) }}
								{{ Form::select('region', array(null => '')+$region,'', array('class' => 'form-control', 'id' => 'district_id')) }}
							</div>
						</div>
					</div>
				</div>
